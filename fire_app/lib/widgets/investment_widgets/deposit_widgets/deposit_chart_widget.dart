...
class DepositLineChart extends StatelessWidget {
  final List<FlSpot> graphDataTotalValue;
  final List<FlSpot> graphDataEarnings;
  final List<FlSpot> graphDataTotalDeposits;

  const DepositLineChart({
    super.key, 
    required this.graphDataTotalValue,
    required this.graphDataEarnings,
    required this.graphDataTotalDeposits,
  });
